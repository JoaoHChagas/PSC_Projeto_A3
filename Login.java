    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
        ...
        try {
            ...
            if("".equals(email.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "Email Address é obrigatório", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }else if("".equals(password.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "A senha é obrigatória", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }else {
            Email    = email.getText();
            ...
            if(notFound == 1 && Password.equals(passDb)){
               ...
               JOptionPane.showMessageDialog(new JFrame(), "email ou senha incorretos", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
            password.setText("");
